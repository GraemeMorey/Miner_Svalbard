...
public class UI {
	...
	String microfossilFact3[] = {"You found the last coccolithophore! Using coccolithophore microfossils /ndated to the Holocene (11 thousand years ago to present), their /nabundance and species composition indicate that the warm flow /nof Atlantic waters and increased sea temperatures has been /noccurring since the Holocene. Their presence across the geological /nrecord help scientists reconstruct past sea surface conditions."};
	
	String dropstoneFact1[] = {"You found a dropstone! Dropstones are typically large /nsedimentary structures, such as rocks or boulders (i.e. clasts), /nthat are surrounded by fine-grained sediment types that /nappear unrelated to these clasts. Why are the dropstones /nthere?"};
	String dropstoneFact2[] = {"You found another dropstone! Dropstones were likely /ntransported far from land by icebergs which had broken off from a /nglacial front. The dropstone melts out of the ice, sinking and /nsettling onto the seafloor."};
	String dropstoneFact3[] = {"You found the last dropstone! Finding dropstones has helped /nresearchers determine that frequent ice cover occurred /naround Svalbard and Greenland. This helps us understand /nthe extent of ice cover and the temperatures of that time period /nof 55 – 23 million years ago."};
	...
	String fossilFact2[] = {"You found another ginkgo fossil! Around Barentsburg, /napproximately 50 species of ginkgos, ferns, conifers, and /nangiosperms were found fossilized in the sediment. Scientists can /nuse numerous leaf characteristics, such as size and lobation, /nto reconstruct past climate. "};
